    ...
    <div class="page-body">
        ...
        <div class="content">
            ...
            <div class="content-header">
                ...
                <div class="leftside-content-header">
                    <ul class="breadcrumbs">
                        <li><i class="fa fa-table" aria-hidden="true"></i><a href="#">Mượn sách</a></li>
                        <li><a>Sách mượn sách</a></li>
                    </ul>
                </div>
            </div>
            <!-- =-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-= -->
            ...
            <div class="row animated fadeInRight">
                <?php if ($borrowedBook == null) {?>
                    <h4>Bạn chưa mượn quyển sách nào</h4>
                <?php }else {?>
                <div class="col-sm-12">
                    <h4 class="section-subtitle"><b>Thông tin sách đã mượn</b></h4>
                    <div class="panel">
