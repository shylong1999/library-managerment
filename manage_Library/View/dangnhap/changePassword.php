        ...
        <div class="content">
            ...
            <div class="content-header">
                ...
                <div class="leftside-content-header">
                    <ul class="breadcrumbs">
                        <li><i class="fa fa-cogs" aria-hidden="true"></i><a href="#">Đổi mật khẩu</a></li>
            ...
            <div class="row animated fadeInUp">
                <div class="col-sm-12 col-md-6 col-md-offset-3">
                    <h4 class="section-subtitle"><b>Đổi mật khẩu</b></h4>
                    <div class="panel">
                        <div class="panel-content">
                            <div class="row">
                                <div class="col-md-12">
                                    <form id="inline-validation" class="form-horizontal form-stripe" action=""
                                          method="post">
                                        <div class="form-group">
                                            <label for="oldpass" class="col-sm-3 control-label">Nhập mật khẩu cũ<span
                                        ...
                                        <div class="form-group">
                                            <label for="newpass" class="col-sm-3 control-label">Nhập mật khẩu mới<span
                                                        class="required">*</span></label>
                                            <div class="col-sm-9">
                                        ...
                                        <div class="form-group">
                                            <label for="newpass_verify" class="col-sm-3 control-label">Nhập lại mật khẩu
                                                mới<span class="required">*</span></label>
                                            <div class="col-sm-9">
                                                <input type="password" class="form-control" id="newpass_verify"
                                                       name="newpass_verify" required>
                                            </div>
                                        </div>
