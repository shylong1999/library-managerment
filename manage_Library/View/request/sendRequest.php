...
<!--                            </li>-->
        ...
        <div class="content">
            ...
            <div class="row animated fadeInUp">
                <div class="col-sm-10 col-md-8 col-md-offset-0">
                    <h4 class="section-subtitle"><b>Yêu cầu mượn sách</b></h4>
                    <div class="panel">
                                ...
                                <div class="col-md-12">
                                    <form id="inline-validation" class="form-horizontal form-stripe" action="" method="post">
                                        <div class="form-group">
                                            <label for="message" class="col-sm-3 control-label">Nội dung yêu cầu<span class="required">*</span></label>
                                            <div class="col-sm-9">
                                                <textarea class="form-control" rows="5" maxlength="6000" id="message" name="message"></textarea>
                                            </div>
                                        </div>
                ...
                <!--TIMELINE left-->
                <div class="col-sm-10 col-lg-4 col-md-offset-0">
                    <div class="timeline">
