    ...
    <div class="page-body">
        ...
        <div class="content">
            ...
            <div class="content-header">
                ...
                <div class="leftside-content-header">
                    <ul class="breadcrumbs">
                        <li><i class="fa fa-table" aria-hidden="true"></i><a href="#">Yêu cầu mượn sách</a></li>
                        <li><a>Xem yêu cầu</a></li>
                    </ul>
                </div>
            </div>
            <!-- =-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-= -->
            ...
            <div class="row animated fadeInRight">
                <div class="col-sm-12">
                    <h4 class="section-subtitle"><b>Danh sách yêu cầu của sinh viên</b></h4>
                    <div class="panel">
                                    ...
                                    <?php
                                        ...
                                        foreach ($dataRequest as $value) {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="index.php?controller=requests&action=delete-request&requestID=<?php echo $value['requestID']; ?>"
                                                       title="Remove quest" onclick="return confirm('Bạn có chắc chắn muốn xóa không?')">
