                        ...
                        <div class="col-sm-4">
                            <div class="thumbnail">
                                ...
                                <div class="caption" style="text-align: center;">
                                    <a href="index.php?controller=thuvien-sach&action=infoBook&id=<?php echo $value['id']; ?>"><strong><?php echo $value['tensach']; ?></strong></a><br>
                                    <a><strong><?php echo $value['tacgia']; ?></strong></a>
                                </div>
                            </div>
                            <!-- </a> -->
                        </div>
