	...
	<div class="dangky">
		...
		<form action="" method="POST">
			<table>
				...
				<tr>
					<td>&nbsp;</td>
					<td><input style="font-size: 20px; background: #EAD2D2"  type="submit" name="add_info" value="Đăng kí mượn sách" onclick="return confirm('Bạn có chắc chắn muốn đăng kí mượn sách?')"></td>
				</tr>
			</table>
		</form>
		<?php 
