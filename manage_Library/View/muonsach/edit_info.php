                                ...
                                <div class="col-md-12">
                                    <form id="inline-validation" class="form-horizontal form-stripe" action="" method="post">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" id="hoten" name="hoten" required value="<?php echo $dataID['hoten']; ?>">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="mssv" class="col-sm-3 control-label">MSSV</label>
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" id="mssv" name="mssv" maxlength="8" required value="<?php echo $dataID['mssv']; ?>">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="select2-example-basic" class="col-sm-3 control-label">Tên sách</label>
                                            <div class="col-sm-9">

                                                <select name="tensach" id="select2-example-basic" class="form-control" style="width: 100%">
                                                    <optgroup label="Book">
                                                        <option value="<?php echo $dataID['tensach']; ?>" label="<?php echo $dataID['tensach']; ?>"><?php echo $dataID['tensach']; ?></option>
                                        ...
                                        <div class="form-group">
                                            <label for="ngaymuon" class="col-sm-3 control-label ">Ngày mượn</label>
                                            <div class="col-sm-9">
                                                <div class="input-group">
                                                    <input type="date" class="form-control" id="ngaymuon" name="ngaymuon" value="<?php echo $dataID['ngaymuon']; ?>">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-offset-3 col-sm-9">
                                                <input type="submit" class="btn btn-primary" name="edit_info" value="Sửa" onclick="return confirm('Bạn có chắc chắn muốn sửa thông tin mượn sách?')">
                                            </div>
                                        </div>
                                    </form>
                                    <?php
                                        if (isset($success) && in_array('add_success', $success)) {
                                            echo "<p style = 'color: red; text-align:center;'>Cập nhật thành công</p>";
                                        }
                                    ?>
                                </div>
                            </div>
